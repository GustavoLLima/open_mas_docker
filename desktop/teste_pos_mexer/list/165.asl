...
joinedWsp(cobj_0,main,"/main")[artifact_id(cobj_1),artifact_name(session_165),percept_type(obs_prop),source(percept),workspace("/main",cobj_0)].
initial_print2.
initial_print.
