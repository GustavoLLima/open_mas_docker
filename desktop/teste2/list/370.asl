// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_7499]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("370 -2 3 4").
previous_2("1-2-3-1-1").
sugar(-2).
initial_print2.
initial_print.
vision(4).
