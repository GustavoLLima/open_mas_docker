// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_6365]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("287 -2 3 3").
previous_2("1-2-1-2-3-2-3").
sugar(-2).
initial_print2.
initial_print.
vision(3).
