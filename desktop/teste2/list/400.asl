// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_12125]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("400 -2 4 6").
previous_2("2-3-1-1-2-2-3-3-1").
sugar(-2).
initial_print2.
initial_print.
vision(6).
...
@p__2687[source(self),url("file:src/agt/regular_agent.asl")] +initial_print <- .print("I'm a regular agent, from the model running").
