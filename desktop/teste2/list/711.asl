// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_9407]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("711 -3 4 1").
previous_2("2-2-1-1-3-1").
sugar(-3).
initial_print2.
initial_print.
vision(1).
