// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_5357]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("368 -2 4 1").
previous_2("1-3-1-2-3-1").
sugar(-2).
initial_print2.
initial_print.
vision(1).
...
@p__1183[source(self),url("file:src/agt/regular_agent.asl")] +initial_print <- .print("I'm a regular agent, from the model running").
