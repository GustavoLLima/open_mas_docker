// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_5573]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("145 -1 3 4").
previous_2("1-3-3-1-2-3").
sugar(-1).
initial_print2.
initial_print.
vision(4).
