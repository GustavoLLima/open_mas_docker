// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_11621]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("384 -2 4 5").
previous_2("1-3-3-2-3-1-2").
sugar(-2).
initial_print2.
initial_print.
vision(5).
