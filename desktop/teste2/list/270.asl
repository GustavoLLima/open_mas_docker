// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_10361]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("270 -3 4 5").
previous_2("1-3-2-1-1").
sugar(-3).
initial_print2.
initial_print.
vision(5).
