// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_11603]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("516 0 3 5").
previous_2("2-1-3-3-1").
sugar(0).
initial_print2.
initial_print.
vision(5).
