// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_7751]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("449 -1 4 3").
previous_2("2-1-1-1-1-2-1-3").
sugar(-1).
initial_print2.
initial_print.
vision(3).
