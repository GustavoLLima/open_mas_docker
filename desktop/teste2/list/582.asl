// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_10523]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("582 0 3 3").
previous_2("2-2-1-3-3-1-3").
sugar(0).
initial_print2.
initial_print.
vision(3).
