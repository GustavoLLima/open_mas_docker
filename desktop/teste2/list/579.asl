// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_4511]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("579 0 3 4").
previous_2("2-3-2-3-1").
sugar(0).
initial_print2.
initial_print.
vision(4).
