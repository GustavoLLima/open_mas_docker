...
metabolism(2).
previous_0("agent").
joinedWsp(cobj_0,main,"/main")[artifact_id(cobj_1),artifact_name(session_142),percept_type(obs_prop),source(percept),workspace("/main",cobj_0)].
previous_1("142 0 2 3").
previous_2("1-3-1-2").
sugar(0).
initial_print2.
initial_print.
