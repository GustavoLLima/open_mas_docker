// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_8885]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("574 -1 4 4").
previous_2("2-2-2-1-3-2").
sugar(-1).
initial_print2.
initial_print.
vision(4).
...
@p__1970[source(self),url("file:src/agt/regular_agent.asl")] +anser_previous(X) <- .print("I've received a message to kill agent ",X); .print("Killing agent ",X).
