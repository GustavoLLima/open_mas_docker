...
metabolism(1).
previous_0("agent").
joinedWsp(cobj_0,main,"/main")[artifact_id(cobj_1),artifact_name(session_253),percept_type(obs_prop),source(percept),workspace("/main",cobj_0)].
previous_1("253 0 1 4").
previous_2("1-3").
sugar(0).
initial_print2.
initial_print.
