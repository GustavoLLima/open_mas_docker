...
metabolism(3).
previous_0("agent").
joinedWsp(cobj_0,main,"/main")[artifact_id(cobj_1),artifact_name(session_717),percept_type(obs_prop),source(percept),workspace("/main",cobj_0)].
previous_1("717 0 3 2").
previous_2("2-1-2-1-1").
sugar(0).
initial_print2.
initial_print.
vision(2).
