// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_10001]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("203 -1 4 1").
previous_2("1-3-2-3-1-3-2").
sugar(-1).
initial_print2.
initial_print.
vision(1).
