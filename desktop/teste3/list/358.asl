// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_11639]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("358 0 3 5").
previous_2("1-1-2-2-2-1-3").
sugar(0).
initial_print2.
initial_print.
vision(5).
