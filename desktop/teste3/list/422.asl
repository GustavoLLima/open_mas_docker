// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_11513]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("422 -1 3 3").
previous_2("2-1-1-2-1-1-1-1").
sugar(-1).
initial_print2.
initial_print.
vision(3).
