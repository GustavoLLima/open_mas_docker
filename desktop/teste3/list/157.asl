...
metabolism(3).
previous_0("agent").
joinedWsp(cobj_0,main,"/main")[artifact_id(cobj_1),artifact_name(session_157),percept_type(obs_prop),source(percept),workspace("/main",cobj_0)].
previous_1("157 -1 3 3").
previous_2("1-2-2-2").
sugar(-1).
initial_print2.
initial_print.
