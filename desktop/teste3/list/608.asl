// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_11765]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("608 0 2 3").
previous_2("2-3-3-2-2-3-2-3-3").
sugar(0).
initial_print2.
initial_print.
vision(3).
