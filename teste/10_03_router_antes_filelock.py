        ...
        if router_type == "random":
            if(os.path.isfile(general_dead_agents_file)):
                if(os.stat(general_dead_agents_file).st_size > 0):
                    ...
                    # # naofacoideia = 0
                    # # open both files
                    # with open(general_dead_agents_file,'r') as firstfile, open("/teste/important/"+str(naofacoideia)+'.txt','a') as secondfile:                          
                                ...
                                for line in lines:
                                    ...
                                    if line.strip('\n') != chosen_agent:
                                        ...
                                        if (found_once > 1):
                                            f.write(line)
                    # # open both files
                    # with open(general_dead_agents_file,'r') as firstfile, open("/teste/important/"+str(naofacoideia)+"_1"+'.txt','a') as secondfile:                          
                    #     # read content from first file
                    #     for line in firstfile:                                   
                    #         # append content to second file
                    #         secondfile.write(line)
