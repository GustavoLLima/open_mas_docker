...
public class aaa_test_jython extends DefaultInternalAction {
    ...
    public Object execute(TransitionSystem ts, Unifier un, Term[] args) throws Exception {
        ...
        try {
            ...
            URL url = new URL("http://localhost:5000/api/v1/resources/books2?model=m1");
            ...
            if (responsecode != 200) {
                ...
                if (arr.size() > 0){
                    for (int i = 0; i < arr.size(); i++) {
                        ...
                        // System.out.println("ID: " + arr2.get(0));
                        // System.out.println("Stats: " + arr2.get(1));
                        // System.out.println("Path: " + arr2.get(2));
                        ...
                        //System.out.println("Size3: " + arr3.size());

                        System.out.println("Att0: " + arr3.get(0));
                        System.out.println("Att1: " + arr3.get(1));
                        System.out.println("Att2: " + arr3.get(2));

                        //JSONObject new_obj = (JSONObject) arr2.get(1);

                        // System.out.println("Arr3: " + new_obj.toString());

                        // System.out.println("Arr3: " + arr2.get(1));



                        //System.out.println("0: "+ arr.get(i).get);
                    } 
                } else {
                ...
                //     if (new_obj.get("Slug").equals("brazil")) {
                //         System.out.println("Total TotalDeaths: " + new_obj.get("TotalDeaths"));
                //         break;
                //     }
                // }
            }
        ...
        //System.out.println("Javav: " + System.getProperty("java.version"));
