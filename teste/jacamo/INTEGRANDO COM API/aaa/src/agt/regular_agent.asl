...
+initial_print : true
  <- .print("I'm a regular agent, from the model running");
	...
	.print("Vindo do agente na criação, previous_0: ",V0);
	.print("Vindo do agente na criação, previous_1: ",V1);
	.print("Vindo do agente na criação, previous_2: ",V2).
...
<- 
	...
	*/
	...
	.abolish(previous_0(_));
	.abolish(previous_1(_));
	.abolish(previous_2(_));
	...
	*/
	...
	.send(killer_agent, tell, kill(V0, V1, V2, X, B0, B1, B2));
	.send(killer_agent, untell, kill(V0, V1, V2, X, B0, B1, B2)).
