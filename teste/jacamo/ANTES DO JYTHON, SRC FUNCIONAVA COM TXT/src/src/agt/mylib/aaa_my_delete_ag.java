...
public class aaa_my_delete_ag extends DefaultInternalAction {
    ...
    public Object execute(TransitionSystem ts, Unifier un, Term[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("Java Args4: "+args[4]);
            System.out.println("Java Args5: "+args[5]);
            System.out.println("Java Args6: "+args[6]);
            
            // String custom_args1 = args[1].replace("\"", "");


            // 10.03 - MONTANDO A STRING SEPARADA, VOLTANDO PRA VERSÃO ANTERIOR QUE USA OS PREVIOUS
            // String custom_args1 = String.valueOf(args[3]) + " " + String.valueOf(args[4]) + " " + String.valueOf(args[5]) + " " + String.valueOf(args[6]);
            ...
            // System.out.println("Args[2]: "+args[2]+" - Custom_Args[2]: "+custom_args2);
            ...
            // 10.03 - FUNCIONANDO, ANTES DE PEGAR OS ATRIBUTOS MANUALMENTE, CRENÇAS NÃO ESTÃO ATUALIZANDO
