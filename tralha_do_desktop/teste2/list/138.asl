...
metabolism(2).
previous_0("agent").
joinedWsp(cobj_0,main,"/main")[artifact_id(cobj_1),artifact_name(session_138),percept_type(obs_prop),source(percept),workspace("/main",cobj_0)].
previous_1("138 -2 2 4").
previous_2("1-3-3").
sugar(-2).
initial_print2.
initial_print.
...
@p__779[source(self),url("file:src/agt/regular_agent.asl")] +initial_print <- .print("I'm a regular agent, from the model running").
