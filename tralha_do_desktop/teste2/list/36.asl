...
metabolism(3).
previous_0("agent").
joinedWsp(cobj_0,main,"/main")[artifact_id(cobj_1),artifact_name(session_36),percept_type(obs_prop),source(percept),workspace("/main",cobj_0)].
previous_1("36 0 3 1").
previous_2("1").
sugar(0).
initial_print2.
