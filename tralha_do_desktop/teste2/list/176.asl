// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_7913]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("176 -3 4 4").
previous_2("1-2-1-3-1").
sugar(-3).
initial_print2.
initial_print.
vision(4).
