// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_10937]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("473 -1 3 6").
previous_2("2-2-2-1-1").
sugar(-1).
initial_print2.
initial_print.
vision(6).
