// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_11711]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("581 -4 4 1").
previous_2("2-2-3-2-3-1").
sugar(-4).
initial_print2.
initial_print.
vision(1).
