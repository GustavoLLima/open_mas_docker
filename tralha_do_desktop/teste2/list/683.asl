// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_11207]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("683 0 3 6").
previous_2("2-2-1-3-1-3-2-2").
sugar(0).
initial_print2.
initial_print.
vision(6).
...
@p__2483[source(self),url("file:src/agt/regular_agent.asl")] +initial_print <- .print("I'm a regular agent, from the model running").
