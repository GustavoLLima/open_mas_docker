// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_11477]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("797 -1 3 1").
previous_2("2-3-1-1-1-3-2").
sugar(-1).
initial_print2.
initial_print.
vision(1).
...
@p__2543[source(self),url("file:src/agt/regular_agent.asl")] +initial_print <- .print("I'm a regular agent, from the model running").
