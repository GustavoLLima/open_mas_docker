// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_10271]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("172 0 3 2").
previous_2("1-1-1-3-3-2-3-3-3").
sugar(0).
initial_print2.
initial_print.
vision(2).
