...
metabolism(4).
previous_0("agent").
joinedWsp(cobj_0,main,"/main")[artifact_id(cobj_1),artifact_name(session_694),percept_type(obs_prop),source(percept),workspace("/main",cobj_0)].
previous_1("694 -4 4 2").
previous_2("2-2").
sugar(-4).
initial_print2.
initial_print.
