...
metabolism(3).
previous_0("agent").
joinedWsp(cobj_0,main,"/main")[artifact_id(cobj_1),artifact_name(session_174),percept_type(obs_prop),source(percept),workspace("/main",cobj_0)].
previous_1("174 -2 3 1").
previous_2("1-1-3-1-1").
sugar(-2).
initial_print2.
initial_print.
vision(1).
