// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_7337]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("457 -1 4 5").
previous_2("2-1-2-1-1-2-1-2").
sugar(-1).
initial_print2.
initial_print.
vision(5).
