// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_10307]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("448 0 3 4").
previous_2("2-1-3-1-1-1-2").
sugar(0).
initial_print2.
initial_print.
vision(4).
