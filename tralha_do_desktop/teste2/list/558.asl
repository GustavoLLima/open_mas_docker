// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_11045]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("558 -2 4 4").
previous_2("2-3-3-3-2-1").
sugar(-2).
initial_print2.
initial_print.
vision(4).
...
@p__2450[source(self),url("file:src/agt/regular_agent.asl")] +anser_previous(X) <- .print("I've received a message to kill agent ",X); .print("Killing agent ",X).
