...
metabolism(3).
previous_0("agent").
joinedWsp(cobj_0,main,"/main")[artifact_id(cobj_1),artifact_name(session_546),percept_type(obs_prop),source(percept),workspace("/main",cobj_0)].
previous_1("546 -1 3 1").
previous_2("2-1-3-2-3").
sugar(-1).
initial_print2.
initial_print.
vision(1).
...
@p__1419[source(self),url("file:src/agt/regular_agent.asl")] +initial_print <- .print("I'm a regular agent, from the model running").
