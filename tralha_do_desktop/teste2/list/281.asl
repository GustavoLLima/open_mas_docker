// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_10613]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("281 -3 4 6").
previous_2("1-2-2-2-3").
sugar(-3).
initial_print2.
initial_print.
vision(6).
