// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_11729]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("408 -2 4 6").
previous_2("2-2-1-1-3").
sugar(-2).
initial_print2.
initial_print.
vision(6).
