// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_11351]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("256 -3 4 4").
previous_2("1-3-2-1-1-1").
sugar(-3).
initial_print2.
initial_print.
vision(4).
