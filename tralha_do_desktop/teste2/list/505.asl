...
metabolism(4).
previous_0("agent").
joinedWsp(cobj_0,main,"/main")[artifact_id(cobj_1),artifact_name(session_505),percept_type(obs_prop),source(percept),workspace("/main",cobj_0)].
previous_1("505 -2 4 5").
previous_2("2").
sugar(-2).
initial_print2.
initial_print.
