// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_8741]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("755 -2 2 1").
previous_2("2-3-3-1-1-2-1").
sugar(-2).
initial_print2.
initial_print.
vision(1).
...
@p__1938[source(self),url("file:src/agt/regular_agent.asl")] +anser_previous(X) <- .print("I've received a message to kill agent ",X); .print("Killing agent ",X).
