// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_10739]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("718 -1 3 1").
previous_2("2-1-2-3-1-2-1").
sugar(-1).
initial_print2.
initial_print.
vision(1).
