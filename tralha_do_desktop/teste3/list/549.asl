...
previous_1("549 0 2 1").
previous_2("2-3-3-2-1").
sugar(0).
initial_print2.
initial_print.
vision(1).
...
@p__2458[source(self),url("file:src/agt/regular_agent.asl")] +anser_previous(X) <- .print("I've received a message to kill agent ",X); .print("Killing agent ",X).
