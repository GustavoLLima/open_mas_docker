// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_7643]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("154 -1 4 6").
previous_2("1-3-2-2-1-3").
sugar(-1).
initial_print2.
initial_print.
vision(6).
...
@p__1691[source(self),url("file:src/agt/regular_agent.asl")] +initial_print <- .print("I'm a regular agent, from the model running").
