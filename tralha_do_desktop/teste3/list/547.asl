// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_6995]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("547 -2 4 3").
previous_2("2-3-1-1-3-1").
sugar(-2).
initial_print2.
initial_print.
vision(3).
