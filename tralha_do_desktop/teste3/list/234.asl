...
metabolism(4).
previous_0("agent").
joinedWsp(cobj_0,main,"/main")[artifact_id(cobj_1),artifact_name(session_234),percept_type(obs_prop),source(percept),workspace("/main",cobj_0)].
previous_1("234 -1 4 6").
previous_2("1-1-2-1-1").
sugar(-1).
initial_print2.
initial_print.
vision(6).
