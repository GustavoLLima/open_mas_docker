...
metabolism(2).
previous_0("agent").
joinedWsp(cobj_0,main,"/main")[artifact_id(cobj_1),artifact_name(session_697),percept_type(obs_prop),source(percept),workspace("/main",cobj_0)].
previous_1("697 -2 2 3").
previous_2("2-2-3-3").
sugar(-2).
initial_print2.
initial_print.
