// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_9299]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("620 -2 4 5").
previous_2("2-2-3-1-1-2-1").
sugar(-2).
initial_print2.
initial_print.
vision(5).
