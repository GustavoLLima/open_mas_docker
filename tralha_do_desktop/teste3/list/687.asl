// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_11531]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("687 -1 3 1").
previous_2("2-1-1-3-3-1-1-2").
sugar(-1).
initial_print2.
initial_print.
vision(1).
