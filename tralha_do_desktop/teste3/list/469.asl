...
metabolism(4).
previous_0("agent").
joinedWsp(cobj_0,main,"/main")[artifact_id(cobj_1),artifact_name(session_469),percept_type(obs_prop),source(percept),workspace("/main",cobj_0)].
previous_1("469 -1 4 4").
previous_2("2-3-1-3-3").
sugar(-1).
initial_print2.
initial_print.
vision(4).
