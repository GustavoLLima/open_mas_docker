...
metabolism(4).
previous_0("agent").
joinedWsp(cobj_0,main,"/main")[artifact_id(cobj_1),artifact_name(session_308),percept_type(obs_prop),source(percept),workspace("/main",cobj_0)].
previous_1("308 -2 4 6").
previous_2("1-2-1-3").
sugar(-2).
initial_print2.
initial_print.
