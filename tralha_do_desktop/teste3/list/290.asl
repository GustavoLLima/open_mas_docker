// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_11855]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("290 -1 4 1").
previous_2("1-1-3-2-3-3-1").
sugar(-1).
initial_print2.
initial_print.
vision(1).
