// beliefs and rules
kqml::bel_no_source_self(NS::Content,Ans) :- (NS::Content[|LA] & (kqml::clear_source_self(LA,NLA) & ((Content =.. [F,T,_8273]) & (Ans =.. [NS,F,T,NLA])))).
...
previous_1("729 -1 4 2").
previous_2("2-1-2-3-1").
sugar(-1).
initial_print2.
initial_print.
vision(2).
...
@p__1831[source(self),url("file:src/agt/regular_agent.asl")] +initial_print <- .print("I'm a regular agent, from the model running").
